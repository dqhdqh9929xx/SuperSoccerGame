...
namespace FStudio.MatchEngine {
    public class MatchManager : SceneObjectSingleton<MatchManager> {
        ...
        /// <summary>
        /// Super Kick mode: when true, holder or first touch will shoot toward Home goal. Cleared on ball out of play.
        /// </summary>
        ...
        protected override void OnEnable() {
            ...
            EventManager.Subscribe<OutEvent>(OnBallOutDisableSuperKick);
            EventManager.Subscribe<ShootWentOutEvent>(OnShootWentOutDisableSuperKick);
            EventManager.Subscribe<GoalEvent>(OnGoalDisableSuperKick);
            EventManager.Subscribe<KeeperSavesTheBallEvent>(OnKeeperSavesDisableSuperKick);
        }
        ...
        private void OnDisable() {
            ...
            EventManager.UnSubscribe<OutEvent>(OnBallOutDisableSuperKick);
            EventManager.UnSubscribe<ShootWentOutEvent>(OnShootWentOutDisableSuperKick);
            EventManager.UnSubscribe<GoalEvent>(OnGoalDisableSuperKick);
            EventManager.UnSubscribe<KeeperSavesTheBallEvent>(OnKeeperSavesDisableSuperKick);
        }
